...
public class PayPalFunctions
{
    ...
    {//lhuynh - Actions to be Done on init of this class
        ...
        gv_APIUser = "seller_1315906318_biz_api1.gmail.com";
        //Fill in the gv_APIPassword variable yourself, the wizard will not do this automatically 
        gv_APIPassword = "1315906389";
        gv_APIVendor = "seller_1315906318_biz_api1.gmail.com";
    ...
    public HashMap httpcall(String nvpStr, String unique_id)
    {
        ...
        String encodedData = "?USER=seller_1315906318_biz_api1.gmail.com"
                + "&PWD=1315906389"
                + "&VERSION=58.0"
                ...
                + "&Zip=94121"
                + "&COUNTRYCODE=US"
                + "&EMAIL=ata.aungthawaye%40gmail.com"
